...
function EmployeeCard({ cardTitle, cardText, email }) {
    ...
    return (
        <>       
        <div className="card w-75" style={{ margin: '12px', maxWidth: '380px', backgroundColor: 'rgba(124, 192, 203, 0.6)', outlineColor: 'rgba(226, 133, 110, 0.8)', height: '350px', position: 'relative' }}>
            ...
            <div className="card-footer" style={{ position: 'absolute', bottom: '10px', left: '12px', right: '12px' }}>
                <button type="button" className="btn btn-primary" onClick={handleOpenModal} style={{ width: '100%',backgroundColor:'rgb(226, 133, 110)' }}>Contact Me!</button>
            </div>
